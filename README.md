...
| Project | Type | Tech |
| :--- | :--- | :--- |
| **🌌 Supernova** | 3D Interactive Portfolio | `Next.js` `Framer Motion` |
| **💼 EliteNext** | SaaS Admin Dashboard | `Next.js` `Shadcn/UI` `TypeScript` |

[👉 View My Full Portfolio](https://my-supernova-portfolio.vercel.app/)
